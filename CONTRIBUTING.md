...
A big welcome and thank you for considering contributing to GitCode! It’s people like you that make it a reality for users in our community.
...
By participating and contributing to this project, you agree to uphold our [Code of Conduct](https://github.com/protocol-software/gitcode-workspace/blob/develop/CODE_OF_CONDUCT.md).

## Getting Started

Contributions are made to this repo via Issues and Pull Requests (PRs). A few general guidelines that cover both:

- To report security vulnerabilities, please contacting the project team at spockwoz@gmail.com.
...
* We follow [Google's Typescript Style Guide](https://github.com/google/gts), but wrap all code at
