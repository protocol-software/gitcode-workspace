...
export class PricingRequestDialogService {
  private dialogRef: MatDialogRef<PricingRequestDialogComponent>;
  ...
  public open(data?: any): Observable<any> {
    ...
    this.dialogRef = this.dialog.open(PricingRequestDialogComponent, config);
